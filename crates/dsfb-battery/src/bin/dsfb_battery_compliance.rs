...
use clap::Parser;
use dsfb_battery::{resolve_compliance_output_dir, run_compliance_workflow};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let output_dir = resolve_compliance_output_dir(&crate_dir, args.output);
    ...
    println!(
        "No production modification statement: {}",
