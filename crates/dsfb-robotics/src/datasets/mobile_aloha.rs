//! mobile_aloha adapter — see crate's docs for provenance.
//!
//! Real data flows through `scripts/preprocess_datasets.py` to
//! `data/processed/mobile_aloha.csv`; the canonical entry point is
//! `paper-lock mobile_aloha` which loads that CSV via
