...
\begin{itemize}
  \item \textbf{Early warning mechanism:} under sustained drift, structural
        ...
        claim that the current SECOM evaluation has already established a robust
...
residual drift.  In the SECOM evaluation, grammar episodes capturing
...
\subsection{False-Alarm and Nuisance Boundary}
...
support later qualification work, explicit calibration of lead-time versus
nuisance trade-offs, and more disciplined benchmarking on richer semiconductor
datasets.
