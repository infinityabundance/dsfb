use dsfb_semiotics_engine::cli::args::ScenarioSelection;
...
use dsfb_semiotics_engine::engine::types::{
    CoordinatedResidualStructure, GrammarReasonCode, GrammarState, GrammarStatus, GroupDefinition,
    GroupResidualPoint, ObservedTrajectory, PredictedTrajectory, SemanticDisposition, SignSample,
    SignTrajectory, SyntaxCharacterization, TrustScalar, VectorSample,
};
